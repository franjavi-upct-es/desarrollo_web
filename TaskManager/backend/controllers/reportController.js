...
const exportTasksReport = async (req, res) => {
  try {
    ...
    worksheet.columns = [
      ...
      { header: "Fecha de entrega", key: "dueDate", width: 30 },
...
const exportUsersReport = async (req, res) => {
  try {
    ...
    const workbook = new excelJS.Workbook();
    const worksheet = workbook.addWorksheet("Informe de tareas del usuario");
    ...
    worksheet.columns = [
      ...
      { header: "Tareas terminadas", key: "completedTasks", width: 20 },
    ];
